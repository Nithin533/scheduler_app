    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          _BasicInfoStep(
            occupation: _occupation,
            onOccupationChanged: (v) => _occupation = v,
            workStart: _workStart,
            onWorkStartChanged: (v) => _workStart = v,
            workEnd: _workEnd,
            onWorkEndChanged: (v) => _workEnd = v,
            workDays: _workDays,
            onWorkDaysChanged: (v) => _workDays = v,
            hasPartTime: _hasPartTime,
            onHasPartTimeChanged: (v) => _hasPartTime = v,
            partTimeStart: _partTimeStart,
            onPartTimeStartChanged: (v) => _partTimeStart = v,
            partTimeEnd: _partTimeEnd,
            onPartTimeEndChanged: (v) => _partTimeEnd = v,
            partTimeDays: _partTimeDays,
            onPartTimeDaysChanged: (v) => _partTimeDays = v,
            sleepTarget: _sleepTarget,
            onSleepTargetChanged: (v) => _sleepTarget = v,
          ),
          _InterestsStep(
            sports: _sports,
            hobbies: _hobbies,
